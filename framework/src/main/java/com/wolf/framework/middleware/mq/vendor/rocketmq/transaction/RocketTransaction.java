...
public class RocketTransaction implements Transaction {
    ...
    private com.wolf.framework.middleware.mq.core.message.Message message;
    ...
    @Override
    public com.wolf.framework.middleware.mq.core.message.Message getMessage() {
        return message;
    }

    @Override
    public void setMessage(com.wolf.framework.middleware.mq.core.message.Message message) {
