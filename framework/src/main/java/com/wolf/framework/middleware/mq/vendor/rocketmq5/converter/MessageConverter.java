package com.wolf.framework.middleware.mq.vendor.rocketmq5.converter;
...
import com.wolf.framework.middleware.mq.vendor.rocketmq5.Rocket5ClientManager;
...
public class MessageConverter {
    ...
    private static void setMessageFields(MessageBuilder messageBuilder, com.wolf.framework.middleware.mq.core.message.Message message) {
    ...
    private static void setUserProperties(MessageBuilder messageBuilder, com.wolf.framework.middleware.mq.core.message.Message message) {
    ...
    public static void mergeRocketMessageProperty(com.wolf.framework.middleware.mq.core.message.Message message, SendReceipt sendReceipt) {
        MessageContext context = message.getMessageContext();
        context.setMqId(sendReceipt.getMessageId().toString());
    }

    public static com.wolf.framework.middleware.mq.core.message.Message toTransactionMessage(MessageView messageView) {
    ...
    public static com.wolf.framework.middleware.mq.core.message.Message toConsumeMessage(MessageView messageView) {
        com.wolf.framework.middleware.mq.core.message.Message message = new com.wolf.framework.middleware.mq.core.message.Message();
