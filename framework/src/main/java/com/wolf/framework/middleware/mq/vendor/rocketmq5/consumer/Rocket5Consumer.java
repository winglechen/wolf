package com.wolf.framework.middleware.mq.vendor.rocketmq5.consumer;
...
import com.wolf.framework.middleware.mq.core.consumer.VendorConsumer;
import com.wolf.framework.middleware.mq.vendor.rocketmq5.Rocket5Factory;
import com.wolf.framework.middleware.mq.vendor.rocketmq5.converter.TagFilterExpressionConverter;
...
public class Rocket5Consumer implements VendorConsumer {
    ...
    public void start() {
        try {
            ...
            throw new WolfException("rocketmq5 consumer start failed");
        }
    }
    ...
    public void suspend() {
        try {
            ...
            throw new WolfException("rocketmq5 consumer suspend failed");
        }
    }
    ...
    public void resume() {
        try {
            ...
            throw new WolfException("rocketmq5 consumer resume failed");
        }
    }
