package com.onedot.win.framework.layer.task.retry;

import lombok.NonNull;
import com.onedot.win.common.util.lang.StringUtil;
import com.onedot.win.framework.layer.task.retry.strategy.Daily7RetryStrategy;
import com.onedot.win.framework.layer.task.retry.strategy.DefaultRetryStrategy;
import com.onedot.win.framework.layer.task.retry.strategy.RetryStrategy;

import java.util.HashMap;

/**
 * com.onedot.win.framework.layer.task.retry
 *
 * @author Wingle
