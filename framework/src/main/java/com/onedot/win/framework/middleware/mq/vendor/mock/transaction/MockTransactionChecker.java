package com.onedot.win.framework.middleware.mq.vendor.mock.transaction;
...
import com.onedot.win.framework.middleware.mq.core.transaction.TransactionCheckerRegistry;
import com.onedot.win.framework.middleware.mq.core.transaction.TransactionResult;
import com.onedot.win.framework.middleware.mq.vendor.rocketmq5.converter.MessageConverter;
import com.onedot.win.framework.middleware.mq.vendor.rocketmq5.converter.result.TransactionResultConverter;
...
public class MockTransactionChecker implements TransactionChecker {
    ...
    public TransactionResolution check(MessageView messageView) {
        com.onedot.win.framework.middleware.mq.core.message.Message message = MessageConverter.toTransactionMessage(messageView);

        com.onedot.win.framework.middleware.mq.core.transaction.TransactionChecker transactionChecker = getTransactionChecker(messageView);
    ...
    private com.onedot.win.framework.middleware.mq.core.transaction.TransactionChecker getTransactionChecker(MessageView messageView) {
