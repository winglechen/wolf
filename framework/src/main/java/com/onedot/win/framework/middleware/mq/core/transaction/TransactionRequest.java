...
import com.onedot.win.framework.middleware.mq.core.message.MessageConverter;
...
/**
 * com.onedot.win.framework.middleware.mq.producer
 *
 * @author Wingle
...
public class TransactionRequest extends ProduceRequest {
    ...
    private TransactionRequest(TransactionRequest.Builder builder) {
        super(builder);
