...
import com.onedot.win.framework.security.filter.http.detector.Detector;
import com.onedot.win.framework.security.filter.http.detector.SqlInjectionDetector;
import com.onedot.win.framework.security.filter.http.detector.XssDetector;
...
public class HttpRequestAttacksDenyFilter implements Filter, InitializingBean {
    ...
    private void handleDetection(HttpServletRequest request, HttpServletResponse response, String message) {
        // @see com.onedot.win.framework.exception.handler.GlobalExceptionHandler
