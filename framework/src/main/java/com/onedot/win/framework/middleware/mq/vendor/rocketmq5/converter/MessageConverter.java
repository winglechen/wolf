package com.onedot.win.framework.middleware.mq.vendor.rocketmq5.converter;
...
import com.onedot.win.framework.middleware.mq.config.MQDefaultConst;
...
import com.onedot.win.framework.middleware.mq.vendor.rocketmq5.Rocket5ClientManager;
...
public class MessageConverter {
    ...
    private static void setMessageFields(MessageBuilder messageBuilder, com.onedot.win.framework.middleware.mq.core.message.Message message) {
    ...
    private static void setUserProperties(MessageBuilder messageBuilder, com.onedot.win.framework.middleware.mq.core.message.Message message) {
    ...
    public static void mergeRocketMessageProperty(com.onedot.win.framework.middleware.mq.core.message.Message message, SendReceipt sendReceipt) {
        MessageContext context = message.getMessageContext();
        context.setMqId(sendReceipt.getMessageId().toString());
    }

    public static com.onedot.win.framework.middleware.mq.core.message.Message toTransactionMessage(MessageView messageView) {
    ...
    public static com.onedot.win.framework.middleware.mq.core.message.Message toConsumeMessage(MessageView messageView) {
        com.onedot.win.framework.middleware.mq.core.message.Message message = new com.onedot.win.framework.middleware.mq.core.message.Message();
