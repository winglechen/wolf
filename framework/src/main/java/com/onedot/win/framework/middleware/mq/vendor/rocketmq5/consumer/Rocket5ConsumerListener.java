package com.onedot.win.framework.middleware.mq.vendor.rocketmq5.consumer;
...
import com.onedot.win.framework.middleware.mq.vendor.rocketmq5.converter.result.ConsumeResultConverter;
...
public class Rocket5ConsumerListener implements MessageListener {
    ...
    public ConsumeResult consume(MessageView messageView) {
        ...
        com.onedot.win.framework.middleware.mq.core.consumer.ConsumeResult result = consumer.consume(messageList);
