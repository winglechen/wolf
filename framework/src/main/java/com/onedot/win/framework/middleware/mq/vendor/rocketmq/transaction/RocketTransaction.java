...
public class RocketTransaction implements Transaction {
    ...
    private com.onedot.win.framework.middleware.mq.core.message.Message message;
    ...
    @Override
    public com.onedot.win.framework.middleware.mq.core.message.Message getMessage() {
        return message;
    }

    @Override
    public void setMessage(com.onedot.win.framework.middleware.mq.core.message.Message message) {
