package com.onedot.win.framework.middleware.mq.vendor.rocketmq.transaction;
...
import com.onedot.win.framework.middleware.mq.core.transaction.TransactionChecker;
import com.onedot.win.framework.middleware.mq.core.transaction.TransactionCheckerRegistry;
import com.onedot.win.framework.middleware.mq.core.transaction.TransactionProducer;
import com.onedot.win.framework.middleware.mq.core.transaction.TransactionResult;
import com.onedot.win.framework.middleware.mq.core.transaction.exception.TransactionListenerNotFoundException;
import com.onedot.win.framework.middleware.mq.vendor.rocketmq.converter.MessageConverter;
import com.onedot.win.framework.middleware.mq.vendor.rocketmq.converter.result.TransactionResultConverter;
...
public class RocketTransactionListener implements TransactionListener {
    ...
    public LocalTransactionState executeLocalTransaction(Message rocketMessage, Object arg) {
        ...
        com.onedot.win.framework.middleware.mq.core.message.Message message = MessageConverter.toTransactionMessage(rocketMessage);
