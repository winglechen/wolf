...
import study.daydayup.wolf.framework.middleware.mq.vendor.rocketmq5.converter.result.ConsumeResultConverter;
...
public class Rocket5ConsumerListener implements MessageListener {
    ...
    public ConsumeResult consume(MessageView messageView) {
        ...
        study.daydayup.wolf.framework.middleware.mq.core.consumer.ConsumeResult result = consumer.consume(messageList);
