...
import study.daydayup.wolf.framework.middleware.mq.core.transaction.TransactionChecker;
import study.daydayup.wolf.framework.middleware.mq.core.transaction.TransactionCheckerRegistry;
import study.daydayup.wolf.framework.middleware.mq.core.transaction.TransactionProducer;
import study.daydayup.wolf.framework.middleware.mq.core.transaction.TransactionResult;
import study.daydayup.wolf.framework.middleware.mq.core.transaction.exception.TransactionListenerNotFoundException;
import study.daydayup.wolf.framework.middleware.mq.vendor.rocketmq.converter.MessageConverter;
import study.daydayup.wolf.framework.middleware.mq.vendor.rocketmq.converter.result.TransactionResultConverter;
...
public class RocketTransactionListener implements TransactionListener {
    ...
    public LocalTransactionState executeLocalTransaction(Message rocketMessage, Object arg) {
        ...
        study.daydayup.wolf.framework.middleware.mq.core.message.Message message = MessageConverter.toTransactionMessage(rocketMessage);
