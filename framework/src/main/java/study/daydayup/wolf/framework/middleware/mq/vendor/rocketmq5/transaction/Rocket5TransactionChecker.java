package study.daydayup.wolf.framework.middleware.mq.vendor.rocketmq5.transaction;
...
import study.daydayup.wolf.framework.middleware.mq.core.transaction.TransactionCheckerRegistry;
import study.daydayup.wolf.framework.middleware.mq.core.transaction.TransactionResult;
import study.daydayup.wolf.framework.middleware.mq.vendor.rocketmq5.converter.MessageConverter;
import study.daydayup.wolf.framework.middleware.mq.vendor.rocketmq5.converter.result.TransactionResultConverter;
...
public class Rocket5TransactionChecker implements TransactionChecker {
    ...
    public TransactionResolution check(MessageView messageView) {
        study.daydayup.wolf.framework.middleware.mq.core.message.Message message = MessageConverter.toTransactionMessage(messageView);

        study.daydayup.wolf.framework.middleware.mq.core.transaction.TransactionChecker transactionChecker = getTransactionChecker(messageView);
    ...
    private study.daydayup.wolf.framework.middleware.mq.core.transaction.TransactionChecker getTransactionChecker(MessageView messageView) {
