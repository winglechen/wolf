...
public class RocketTransaction implements Transaction {
    ...
    private study.daydayup.wolf.framework.middleware.mq.core.message.Message message;
    ...
    @Override
    public study.daydayup.wolf.framework.middleware.mq.core.message.Message getMessage() {
        return message;
    }

    @Override
    public void setMessage(study.daydayup.wolf.framework.middleware.mq.core.message.Message message) {
