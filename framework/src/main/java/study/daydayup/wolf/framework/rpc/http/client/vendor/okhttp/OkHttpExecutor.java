package study.daydayup.wolf.framework.rpc.http.client.vendor.okhttp;
...
import study.daydayup.wolf.framework.security.sensitive.SensitiveHttpHeaderFilter;
        ...
        try {
            ...
            if (!response.isSuccess()) {
                log.info("HttpClient call request url: {}; request header: {}; request data: {}; response: {}; response header: {}; response data: {}",
                        request.url(),
                        SensitiveHttpHeaderFilter.erase(requestBuilder.getHeader()),
