...
public class VirtualPrimaryKeyPlugin extends PluginAdapter {
    ...
    /* (non-Javadoc)
     * @see study.daydayup.wolf.common.generator.mybatis.api.Plugin#validate(java.util.List)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see study.daydayup.wolf.common.generator.mybatis.api.PluginAdapter#initialized(study.daydayup.wolf.common.generator.mybatis.api.IntrospectedTable)
     */
    @Override
