package study.daydayup.wolf.common.util.lb.weight;
...
/**
 * study.daydayup.wolf.common.util.lb
 *
 * @author Wingle
...
public class WeightBalance {
    ...
    public void init() {
        ...
        if (CollectionUtil.isEmpty(nodeList)) {
            throw new IllegalArgumentException("Payment channel is not configured");
        }
