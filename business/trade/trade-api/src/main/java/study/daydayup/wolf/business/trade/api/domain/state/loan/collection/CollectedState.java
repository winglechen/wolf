package study.daydayup.wolf.business.trade.api.domain.state.loan.collection;
...
public class CollectedState extends AbstractTradeState implements TradeState {
    {
        code = 10;
    }
