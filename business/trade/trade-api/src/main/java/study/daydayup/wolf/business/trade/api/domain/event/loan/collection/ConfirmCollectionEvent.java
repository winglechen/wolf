package study.daydayup.wolf.business.trade.api.domain.event.loan.collection;
...
@NoArgsConstructor
public class ConfirmCollectionEvent extends AbstractTradeEvent implements TradeEvent {
    @NotNull @Min(1)
    private Long amount;
}
