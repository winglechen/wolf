package study.daydayup.wolf.business.trade.api.domain.state.loan.contract;
...
public class AutoRefusedState extends AbstractTradeState implements TradeState {
    {
        code = 211;
    }
}
