...
(
    ...
    `product_id`        BIGINT(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '卖家ID',
    ...
    `product_version`   INT(11) UNSIGNED    NOT NULL DEFAULT 0 COMMENT '版本号',
    `sku`               VARCHAR(1000) NOT NULL DEFAULT '' COMMENT 'sku',
    `product_name`      VARCHAR(100) NOT NULL DEFAULT '' COMMENT '产品名',
    `product_main_pic`  VARCHAR(100) NOT NULL DEFAULT '' COMMENT '产品主图',
